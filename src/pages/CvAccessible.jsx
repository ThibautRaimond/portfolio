...
function CvAccessible() {
  return (
    ...
    <li>Périmètre : Audit RGAA et RAAM ; Livrables clients ; Restitution</li>
    <li>Accompagnement client ; Gestion des contestations ; Recette</li>
    <li>Élaboration de préconisations ; Relectures ; Optimisation qualitative</li>
    </ul>
    </article>
...
{/* --------- LANGAGES & LOGICIELS ---------  */}
    <section className="mb-8">
    <h3 className="text-2xl font-semibold mb-4 border-b-2 border-gray-700 pb-2 text-[#FFA500]">Langages et Logiciels</h3>
    <ul className="list-disc ml-5 space-y-1">
    ...
    <p>Formation au management de l'équipe, gestion opérationnelle de l'unité
    commerciale et de la relation client. Animation et dynamisation de l'offre.</p>
    </article>
    </section>
