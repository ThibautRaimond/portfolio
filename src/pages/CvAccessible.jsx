    ...
    GitHub
      ...
      <section className="mb-8">
        ...
        <article className="mb-4">
          ...
          <p className="text-sm text-gray-400 mb-2">02/2017 à 2022</p>
          <ul className="list-disc ml-5 space-y-1">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5 space-y-1">
          ...
          <li>Méthodes AGILE & SCRUM</li>
          <li>HTML/CSS, JavaScript, React, Node.js</li>
          <li>Jira, Figma, Mocodo, Canva</li>
          <li>Adaptabilité, rigueur, créativité, organisation</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5 space-y-1">
          ...
          <li>Fitness, randonnée en terrils et forêts</li>
