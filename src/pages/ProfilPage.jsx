					...
					<div className="flex">
						...
						<div className="min-w-[300px]">
							...
							<p className="py-4 text-xl text-center max-w-xl mt-5">
								...
								FullStack Web & Mobile de niveau <abbr title="Répertoire National des Certifications Professionnelles">RNCP</abbr>  5 (baccalauréat +2).
							...
							<p className="text-xl text-center max-w-xl mt-5">
								...
								conduit à devenir consultant dans ce domaine au sein de l’entreprise{' '}
								<a
